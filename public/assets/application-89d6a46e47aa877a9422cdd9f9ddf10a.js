  ...
  $(function() {
    ...
    ready = function() {
      ...
      return $(document).click(function() {
        return $(".subcategories_choice").slideUp("fast");
      });
    };
...
(function() {
  $(document).on("page:change", function() {
    return $('#new_message_link').click(function() {
      $('.new_message_modal').fadeIn();
      return $('.modal_content').fadeIn();
    });
  });
...
(function() {
  $(function() {
    var ready;
    ready = function() {
      $("[data-gravatar]").click(function() {
        $('#gravatar_' + $(this).data("gravatar")).slideToggle(500);
        return $('#user_info_' + $(this).data("gravatar")).slideToggle(500);
      });
      return $("[data-user-info]").click(function() {
        $('#gravatar_' + $(this).data("user-info")).slideToggle(500);
        return $('#user_info_' + $(this).data("user-info")).slideToggle(500);
      });
    };
    $(document).ready(ready);
    return $(document).on('page:load', ready);
